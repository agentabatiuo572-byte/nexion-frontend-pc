...
| E | 任务单价 / 上架阶段门(E1) / 任务产能·trade-in(E3) / 订单(E4) / 运维(E5) | 改单价 / 放行上架 / 调产能节奏·补贴天数·SKU 递减开关·折抵 / 退款·补建终态 / DC pause | ✅ 已落地 · `updateTask` + `setParam`(E.gen/E.device/E.tradein/E.order/E.ops)+ 操作确认 |
