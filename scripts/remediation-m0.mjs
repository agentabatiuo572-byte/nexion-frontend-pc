...
function generateBusinessFlows() {
  const flows = [
    ...
    ["FRONT-004", "uniapp", "提现地址管理到提现申请与 tracking", ["#/pages/me/wallet-address-rebind", "#/pages/me/wallet-withdraw", "#/pages/me/wallet-withdraw-tracking"]],
    ...
    ["ADMIN-005", "admin", "处置风险用户：冻结、解冻、人工评分覆盖", ["/risk/scoring", "/users/search/[id]"]],
...
function generateFeatureMapping() {
  const rows = [
    ...
    ["FM-003", "Withdrawal rules: min, cap, fee, daily count, address freeze", ["#/pages/me/wallet-withdraw"], ["/finance/params", "/risk/withdrawal-rules"]],
    ["FM-004", "Top-up channels copy/status", ["#/pages/me/wallet-topup"], ["/finance/recon", "/content/i18n"]],
    ...
    ["FM-015", "Account security, user freezes, risk score display", ["#/pages/me/security"], ["/risk/scoring", "/users/search"]],
