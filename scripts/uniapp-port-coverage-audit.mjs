...
const EXPECTED_EXTRA_UNI_ROUTES = new Set(["/#/pages/onboarding/terms"]);
...
for (const page of uniPages) {
  if (!runtimeByRoute.has(page.h5Url)) findings.push({ issue: "missing-uni-runtime-evidence", route: page.h5Url });
}
