    ...
    openActionConfirm({
      ...
      detail: <>
        ...
        <div className="gtint" data-proof="g1-apy-preview" style={{ marginTop: 10 }}>
          ...
          <div>当前累计应付利息:<b>{fmtM(stats.interestUsd)}</b> · 数据源 nx_staking_position</div>
  ...
  return (
    <>
      ...
      <div className="f-stats">
        ...
        <div className="f-stat warn"><div className="k">累计应付利息</div><div className="v">{fmtM(stats.interestUsd)}</div><div className="sub">按已锁天数线性派生 · nx_staking_position</div></div>
      ...
      <p className="f-foot"><b>三道硬门</b>:① 升 APY / 降罚款 = 放大资金流出,提交即由后端验备付金覆盖率红线,低于红线拒绝(422);② 同产品长期档 APY 必须 ≥ 相邻短期档(保序),违反拒绝并提示冲突档;③ 单档熔断提案必须随附在锁单处置方案。在锁单按开锁时锁定的利率结算,改参数不追溯历史。当前覆盖率 <b>{cov}%</b>,红线 <b>{redline}%</b>,数据来自 <b>nx_staking_product / nx_staking_position</b>。</p>
