 ...
 * label = 运营可读功能名(给人看)· biz = 所属业务中文名;ep/domain = 技术标识(后台契约,UI 作小号副标)。 ===== */
export const GEO_ENDPOINTS = [
  { ep: "/genesis/*", label: "创世节点购买", biz: "Genesis 经济", domain: "G4", geo: ["KP", "IR", "SY", "CN", "US"], src: "explicit", srcDesc: "前端显式声明屏蔽国家", hits: 104 },
  { ep: "/exchange/swap", label: "NEX 兑换", biz: "NEX 兑换", domain: "G2", geo: ["KP", "IR", "SY", "RU"], src: "derived", srcDesc: "OFAC/FATF 链路派生", hits: 62 },
  // 设计稿标 E5;工程导航收编后 Trade-in 归 E3(生命周期 & Trade-in),按原型现状取 E3。
  { ep: "/tradein/*", label: "以旧换新", biz: "设备生命周期", domain: "E3", geo: [] as string[], src: "pending", srcDesc: "V4 待补 (Ch17 收口)", hits: 0 },
  { ep: "/withdraw/*", label: "提现", biz: "资金提现", domain: "D2", geo: ["KP", "IR", "SY"], src: "derived", srcDesc: "承袭全局黑名单", hits: 24 },
  { ep: "/staking/pool/*", label: "质押池", biz: "Staking 锁仓", domain: "G1", geo: ["KP", "IR", "SY"], src: "derived", srcDesc: "承袭全局黑名单", hits: 11 },
  { ep: "/auth/register", label: "注册", biz: "账户与登录", domain: "C1", geo: ["KP", "IR", "SY"], src: "derived", srcDesc: "承袭全局黑名单", hits: 8 },
  { ep: "/me/wallet/exchange", label: "钱包内兑换", biz: "NEX 兑换", domain: "G2", geo: ["KP", "IR", "SY", "RU"], src: "derived", srcDesc: "承袭 + OFAC/FATF", hits: 3 },
];
...
export const PLAYBOOKS: Playbook[] = [
  ...
  },
  {
    ...
    seq: [
      { dom: "J2", ax: "**升级封禁** 国家黑名单", approve: true },
