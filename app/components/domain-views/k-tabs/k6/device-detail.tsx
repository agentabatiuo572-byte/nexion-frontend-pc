...
import { decisionTrace } from "@/lib/mock/admin/janus-c2/evaluate";
import { isFresh, timeAgo } from "@/lib/mock/admin/janus-c2/scoring";
import {
  ACTION_TYPE_LABEL,
  ROLE_LABEL,
  STATUS_EXPLAIN,
...
import { allowedTransitions, gatedTransitions, type Transition } from "@/lib/mock/admin/janus-c2/transitions";
import type { Device } from "@/lib/mock/admin/janus-c2/types";
...
export function K6DeviceDetail({ device: d, onClose }: { device: Device; onClose: () => void }) {
  ...
  const trace = decisionTrace(d, strategies);
