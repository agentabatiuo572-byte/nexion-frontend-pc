 ...
 * 单源:后端 /content/nova/overview;空库时后端写入 nx_config_item 种子后再查出。
...
export function I2Nova({ ctx }: { ctx: ICtx }) {
  ...
  const I2_STATS = data?.stats ?? { todayDelivered: "—", ctr: "—", ctrTarget: 25, onlineChannels: 0, totalChannels: 0, weeklySocial: "—" };
