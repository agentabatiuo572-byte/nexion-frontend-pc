 ...
 *   I.session.cat.<type>.enabled(I9 类别启停)/ I.session.advisor.policy.<field>(I9 顾问 AutoPushPolicy)/
 *   I.session.script.<id>.status(I9 顾问话术)/ I.session.tpl.<id>.status(I9 即时回复模板)/
 *   I.session.convos(I9 坐席会话,字段镜像 UniApp mock/conversations.ts)。
