...
export const DOMAIN_C: ModuleEntry[] = [
  ...
  {
    path: "/users/security",
    summary: "单个用户的账户安全处置页(C5):两步验证、登录会话、重置密码、解除锁定。核心是防止骗子套话夺号:关掉两步验证、重置密码都要经过高风险操作确认;密码只存加密后的、谁都看不到明文。锁定分两档解锁:15 分钟短锁走安全校验,24 小时长锁要走确认。解锁的处置权都在本页,而「什么情况下锁」的阈值在 C6 配。",
    content: PORTED_EMPTY_CONTENT,
  },
  {
    path: "/users/reg-risk",
