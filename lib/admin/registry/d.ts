...
export const DOMAIN_D: ModuleEntry[] = [
  ...
  {
    path: "/finance/params",
    summary: "提现参数配置(D5)。本轮只开放已由真实提现链消费的每日次数、余额上限、三网络固定确认费与 NEX 抵扣率；变更基于版本号原子提交并留审计，放大资金流出方向还要先过 B1 覆盖率红线。小额免审与到账时效执行器尚未闭环，单列 HOLD 且不提供修改。到账审查窗口与加强合规审查由 H1 Phase 单一派发，本页只读展示并提供 H1 跳转。",
    content: PORTED_EMPTY_CONTENT,
  },
  {
