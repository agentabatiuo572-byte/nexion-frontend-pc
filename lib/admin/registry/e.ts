...
export const DOMAIN_E: ModuleEntry[] = [
  ...
  },
  {
    ...
    summary: "设备生命周期 & 以旧换新(E3)—— 旧机折抵率、最短持有期和残值规则。受地区封锁约束(开启前要按 Ch17 核验);折抵的残值只能抵新机货款、不进可提余额,折抵和下单一笔完成(要么都成、要么都回滚)。改规则走操作确认,会联动 E1 的折扣叠加和旧机退役流转。",
    content: PORTED_EMPTY_CONTENT,
  },
  {
    path: "/devices/orders",
  ...
  },
  {
    ...
    summary: "算力与设备配置(E6)—— 集中管设备算力的四块配置:① 电脑算力入口开关(开/关用户自带 PC 算力接入);② 在线加成系数(在线设备的算力/收益加成倍率);③ 显卡映射表 G1-G6(显卡型号到算力档位的映射基准);④ 客户端下载配置(下载地址、版本、强制升级开关)。这些项是全网算力计酬基准和客户端拉取源头,改动作走操作确认并记入 A2 审计,会联动 E2 收益引擎和 E5 设备运维。",
    content: PORTED_EMPTY_CONTENT,
  },
];
