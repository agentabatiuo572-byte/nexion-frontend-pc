...
export const DOMAIN_G: ModuleEntry[] = [
  ...
  },
  {
    ...
    summary:
      "Genesis 创世经济(G4)。1,000 个节点、每个 $9,999 + 每日分红 0.1%/天(已裁定)+ 二级转售版税 2.5%。分红按两套口径算:按当日交易量派发(日交易量 × 0.1% ÷ 1,000 个节点 ≈ $24/节点/天)+ 按保底预提(节点价 × 0.1% 挂在负债科目 #4),超出保底的部分当期消化。每天 UTC 00:00 批量派发、带防重复;调高分红率要过 B1 红线并附 PM 决议出处。市场熔断、地区封锁在 J1/J2 那边生效;分红权跟着节点 NFT 走。",
