 ...
 *
 * 取自《Nexion 运营控制后台 PRD》Ch3 §3.2/§3.3 权威菜单树:12 域 × 66 个 L2 入口(E 域 7→5、F 域 8→5 收编后,I8 支持后台补面)。
...
export const CONSOLE_NAV: NavDomain[] = [
  ...
  },
  {
    ...
    l2: [
      ...
      { id: "I8", name: "客服支持 CMS", path: "/content/support", prdAnchor: "I8", batch: "V4", status: "flagship" },
    ],
  },
  {
    code: "J",
...
export const L2_COUNT = ALL_L2.length; // 66(F 域 8→5 F6/F7/F8 并入 F4;E 域 7→5 E2 并入 E1、E4 并入 E5;I8 support 补面)
