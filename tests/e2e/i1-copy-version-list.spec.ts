...
test("I1 管理全部文案版本并由系统生成版本号", async ({ page }) => {
    ...
    await route.fulfill({
      ...
      body: JSON.stringify({
        ...
        data: {
          ...
          copies: [{ key: "home.hero", desc: "首页主横幅", surface: "home", version: "v1", status: "published", i18nKey: "home.hero", expId: "EXP-1", lastChange: "刚刚", copyPosition: "home.hero" }],
          versions: [{ copyKey: "home.hero", version: "v1", status: "published", chain: "创建 → 发布", ts: "刚刚", zh: "欢迎回来", vi: "Chào mừng trở lại", en: "Welcome back", copyPosition: "home.hero", surface: "home", audience: "P1-P6 · 全语言 · 注册>0天", trafficSplit: "50", versionNote: "首版" }],
          experiments: [{ id: "EXP-1", copyKey: "home.hero", variants: [{ name: "A · v1", split: 50, cvr: 5.2 }, { name: "B · v2", split: 50, cvr: 5.6 }], audience: "P1-P6 · 全语言 · 注册>0天", estimatedAudience: 18420, impressions: "12,000", conversions: "648", state: "running", note: "进行中" }],
          frameworkParams: [],
  ...
  await expect(versionList.locator("tbody tr")).toHaveCount(1);
